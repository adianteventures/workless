    ...
    module Scaler
      ...
      def self.included(base)
        ...
        if base.to_s =~ /ActiveRecord/
          base.class_eval do
            # trigger up_or_down on each table modification: this method will compute
            #   if scaler.up or scaler.down is required
            after_commit "self.class.scaler.up_or_down"
          end          
